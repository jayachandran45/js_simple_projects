...
var _parse = _interopRequireDefault(require("./parse.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./v1.js":"node_modules/uuid/dist/esm-browser/v1.js","./v3.js":"node_modules/uuid/dist/esm-browser/v3.js","./v4.js":"node_modules/uuid/dist/esm-browser/v4.js","./v5.js":"node_modules/uuid/dist/esm-browser/v5.js","./nil.js":"node_modules/uuid/dist/esm-browser/nil.js","./version.js":"node_modules/uuid/dist/esm-browser/version.js","./validate.js":"node_modules/uuid/dist/esm-browser/validate.js","./stringify.js":"node_modules/uuid/dist/esm-browser/stringify.js","./parse.js":"node_modules/uuid/dist/esm-browser/parse.js"}],"store.js":[function(require,module,exports) {
"use strict";

var _index = require("./node_modules/uuid/dist/esm-browser/index.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); } // importing modules to get uuid for every product that we created
var gridEle = document.querySelector(".gird-container");
var appendEle = document.querySelector(".append");
var cloneEle = document.querySelector(".card");
var cloneCartEle = document.querySelector(".cart-card");
var iEle = document.querySelector("i");
var cardItem = [];
var cartCardItem = [];
...
if (cartCardItem.length) {
  cartCardItem.forEach(function (e) {
    ...
    var appendChildEle = document.querySelectorAll(".append > div");
    var arrColor = [];
    appendChildEle.forEach(function (e) {
      var color = e.querySelector(".cart-main").style.backgroundColor;
      arrColor.push(color);
    });
    if (appendChildEle.length === 0) {
      ...
      //   }
      // });
      for (var i = 0; i < appendChildEle.length; i++) {
        if (arrColor.includes(color)) {
          count = Number(appendChildEle[arrColor.indexOf(color)].querySelector(".no-order").innerHTML);
          count += 1;
          appendChildEle[arrColor.indexOf(color)].querySelector(".no-order").innerHTML = count;
          break;
        } else {
          addCartCard(color, description, amount);
          break;
...
function addCard(color, description, money) {
  var cardClone = cloneEle.content.cloneNode(true);
  // Getting all dynamically added elements which are going to change every time when we add an product
  var mainEle = cardClone.querySelector(".main");
  var colorTextEle = cardClone.querySelector(".color");
  var descriptionEle = cardClone.querySelector(".description");
  var amountEle = cardClone.querySelector(".amount");
...
document.addEventListener("click", function (e) {
  if (e.target.matches("#addtocart")) {
    var count = 1;
    var cardParent = e.target.closest(".body").parentElement;
    var color = cardParent.querySelector(".main").style.backgroundColor;
    var description = cardParent.querySelector(".description").innerHTML;
    var amount = cardParent.querySelector(".amount").innerHTML;
...
function addCartCard(cartColor, cartDescription, cartAmout) {
  var CartCard = cloneCartEle.content.cloneNode(true);
  var colorDiv = CartCard.querySelector(".cart-main");
...
document.addEventListener("click", function (e) {
  if (e.target.matches(".remove")) {
    var count = parseInt(e.target.parentElement.querySelector(".no-order").innerHTML);
    console.log(count, _typeof(count));

    // remove the entire element when count is 0
    e.target.parentElement.querySelector(".no-order").innerHTML = count - 1;
    if (count === 1) {
      var removeEle = e.target.parentElement.parentElement;
      removeEle.remove();
    }
    // to remove element from cart card item array
    var color = e.target.parentElement.querySelector(".cart-main").style.backgroundColor;
    var index = cartCardItem.findIndex(function (e) {
...
},{"./node_modules/uuid/dist/esm-browser/index.js":"node_modules/uuid/dist/esm-browser/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
